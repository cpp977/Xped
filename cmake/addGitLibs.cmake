...
if(${XPED_TENSOR_LIB} STREQUAL "CYCLOPS_TENSOR" AND XPED_BUILD_CYCLOPS)
  ...
  if(XPED_USE_OPENMP)
    ...
    elseif(${CMAKE_BUILD_TYPE} STREQUAL "Debug")
      list(APPEND cmd_configure " CXXFLAGS=\"-O0 -g -fPIC -march=native -fopenmp\"")
    endif()
  else()
    if (${CMAKE_BUILD_TYPE} STREQUAL "Release")
      list(APPEND cmd_configure " CXXFLAGS=\"-O3 -fPIC -march=native -DOMP_OFF\"")
    elseif(${CMAKE_BUILD_TYPE} STREQUAL "Debug")
      list(APPEND cmd_configure " CXXFLAGS=\"-O0 -g -fPIC -march=native -DOMP_OFF\"")
    endif()
  endif()
  if(XPED_USE_BLAS)
  ...
  if(${CMAKE_Fortran_COMPILER_VERSION} VERSION_GREATER_EQUAL 10)
    list(APPEND cmd_patch " sed -i 's/cmake \\.\\. -DBUILD_STATIC_LIBS=ON -DBUILD_SHARED_LIBS=OFF/FC=${XPED_FC_COMPILER} cmake \\.\\. -DBUILD_STATIC_LIBS=ON -DBUILD_SHARED_LIBS=OFF -DCMAKE_Fortran_FLAGS=-fallow-argument-mismatch -DMPIEXEC_EXECUTABLE=${XPED_MPIEXEC_EXECUTABLE}/g' ${CYCLOPS_ROOT}/src/cyclops/configure\;")
  else()
    list(APPEND cmd_patch " sed -i 's/cmake \\.\\. -DBUILD_STATIC_LIBS=ON -DBUILD_SHARED_LIBS=OFF/FC=${XPED_FC_COMPILER} cmake \\.\\. -DBUILD_STATIC_LIBS=ON -DBUILD_SHARED_LIBS=OFF -DMPIEXEC_EXECUTABLE=${MPIEXEC_EXECUTABLE}/g' ${CYCLOPS_ROOT}/src/cyclops/configure\;")
  endif()
