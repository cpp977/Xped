...
struct U0 : SymBase<U0<Scalar_>>
{
    ...
    inline static typename PlainLib::template TType<Scalar, 2> one_j_tensor(const qType&, XPED_CONST mpi::XpedWorld& world = mpi::getUniverse())
    {
    ...
    CGC(const qType&, const qType&, const qType&, const std::size_t, XPED_CONST mpi::XpedWorld& world = mpi::getUniverse())
    {
        typedef typename PlainLib::Indextype IndexType;
