...
struct U1 : public SymBase<U1<Kind, Scalar_>>
{
    ...
    static typename PlainLib::template TType<Scalar_, 2> one_j_tensor(const qType&, XPED_CONST mpi::XpedWorld& world = mpi::getUniverse())
    {
    ...
    CGC(const qType& q1, const qType& q2, const qType& q3, const std::size_t, XPED_CONST mpi::XpedWorld& world = mpi::getUniverse());
...
U1<Kind, Scalar_>::CGC(const qType& q1, const qType& q2, const qType& q3, const std::size_t, XPED_CONST mpi::XpedWorld& world)
{
    typedef typename PlainLib::Indextype IndexType;
