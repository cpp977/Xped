...
typename PlainLib::template TType<Scalar_, 2> SU2<Kind, Scalar_>::one_j_tensor(const qType& q1, XPED_CONST mpi::XpedWorld& world)
{
...
SU2<Kind, Scalar_>::CGC(const qType& q1, const qType& q2, const qType& q3, const std::size_t, XPED_CONST mpi::XpedWorld& world)
{
    typedef typename PlainLib::Indextype IndexType;
...
#if __has_include("SU2.gen.cpp") && XPED_COMPILED_LIB
#    include "SU2.gen.cpp"
#endif
