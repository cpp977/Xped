...
{
    {
        ...
        Xped::Log::init_logging(world, "main");
        ...
        // auto cdagc =
        //     -1. * (F2.cdag(Xped::SPIN_INDEX::UP, 0) * F2.c(Xped::SPIN_INDEX::UP, 1) - F2.c(Xped::SPIN_INDEX::UP, 0) * F2.cdag(Xped::SPIN_INDEX::UP,
        //     1)
        //     +
        ...
        // auto cdagc2 =
        //     (-1. * (tprod(F1.cdag(Xped::SPIN_INDEX::UP), F1.c(Xped::SPIN_INDEX::UP)) - tprod(F1.c(Xped::SPIN_INDEX::UP),
        //     F1.cdag(Xped::SPIN_INDEX::UP))
        //     +
        ...
        Xped::Log::on_entry("Number of MPI processes: {}", world.np);
        Xped::Log::on_entry("I am process number #={}", world.rank);
