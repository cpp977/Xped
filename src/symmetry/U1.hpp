...
template<typename Kind, typename Scalar_> struct U1;
...
struct U1 : public SymBase<U1<Kind, Scalar_> >
{
	...
	inline static Scalar coeff_6j(const qType& q1, const qType& q2, const qType& q3,
        ...
        inline static Scalar coeff_recouple(const qType& q1, const qType& q2, const qType& q3, const qType& Q,
	...
	inline static Scalar coeff_9j(const qType&, const qType&, const qType&,
                                      ...
                                      const qType&, const qType&, const qType&) {return Scalar(1);}
